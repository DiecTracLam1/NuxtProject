...
//   <img v-lazy="https://joanieclothing.com/wp-content/uploads/2023/02/BODY-IMAGE-2.jpg" data-src="https://joanieclothing.com/wp-content/uploads/2023/02/BODY-IMAGE-2.jpg" class="mx-auto" alt="">
...
const description = computed(() => {
  const description = blogDetail.value?.data.blog.description.replace(
    /src/g,
    "data-src"
  );
  return description;
